// ─── FamilyQuest Design System — "Golden Hour" Theme ─────────────────────────
// Deep dusk purple → warm amber · No competitor owns this space in travel apps

export const Colors = {
  // ── Brand / CTA ───────────────────────────────────────────────────────────
  primary:      '#E8651A',   // Warm amber-orange — all CTAs
  primaryLight: '#F0832E',
  primaryDark:  '#C4501A',
  primaryGlow:  'rgba(232, 101, 26, 0.45)',
  ...
  creamDark:    '#FFE8D0',   // Slightly deeper cream
  surface:      '#FFFFFF',
  surfaceWarm:  '#FFFBF7',
  ...
  // ── Text ──────────────────────────────────────────────────────────────────
  textDark:     '#2D1B0E',   // Warm near-black
  textMid:      '#7A4E35',   // Warm mid-brown
  textLight:    '#B07050',   // Muted amber-brown
  textOnDark:   '#FFF8F0',
...
export const Gradients = {
  heroWelcome: ['#0D0520', '#1C1035', '#3D1F6E', '#7B3F00', '#C4622D'] as const,
  heroItinerary: ['#0D0520', '#1C1035', '#3D1F6E', '#7B3F00', '#C4622D'] as const,
  headerLight: ['#FFF8F0', '#FFE8D0'] as const,
  primaryCTA:  ['#E8651A', '#C4501A'] as const,
